...
commom/img/bg-software2.jpg" alt="Data Point" title="Data Point">
                <div class="width-default">
                    <h1 class="titulo-faixa-interna"> Data Point </h1>
                </div>
                <img class="pull-right abs-right hidden-xs" src="<?php echo $this->_tpl_vars['URL']; ?>
commom/img/topo-interna-software.jpg" alt="Data Point" title="Data Point">
            </article> 
            <!-- Banner -->
            <?php $_smarty_tpl_vars = $this->_tpl_vars;
                            ...
                            <div class="encapsula-desc-prod pd-tp-30">
                                <div class="bloco-desc-prod">
                                    ...
                                    <ul class="bloco-linha-interna no-bg">
                                        ...
                                        <li class="linha-ul-interna">Simplifiqua o desenvolvimento de consultas complexas e a integração de dados.</li>
                                        <li class="linha-ul-interna">Elabora perfis de dados para garantir a precisão.</li>
                                    ...
                                    <ul class="bloco-linha-interna no-bg">
                                        ...
                                        <li class="linha-ul-interna">Encontra e corrije problemas de qualidade de dados de forma fácil e rápida</li>
