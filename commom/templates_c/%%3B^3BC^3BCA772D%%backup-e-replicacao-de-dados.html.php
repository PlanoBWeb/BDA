<?php /* Smarty version 2.6.12, created on 2016-03-09 19:04:33
...
software/dell/backup-e-replicacao-de-banco-de-dados/litespeed-for-sql"> O LiteSpeed for SQL Server garante backup e restauração de alta velocidade e com armazenamento eficiente para bancos de dados SQL Server, com até 85% de economia no tamanho e na duração do backup em comparação às soluções concorrentes. Ao oferecer uma ampla variedade de opções de recuperação, o LiteSpeed garante que os dados certos do SQL Server sejam restaurados e fiquem disponíveis o mais rápido possível, além disso, integra-se ao Amazon S3 para oferecer backup baseado em cloud computing e restauração para instâncias locais e do SQL Server Amazon EC2.  </a></p>
                    ...
                    <div class="row pd-tp-30">
                        <div class="col-xs-12 col-sm-3 col-md-3">
                            <a href="<?php echo $this->_tpl_vars['URL']; ?>
software/dell/backup-e-replicacao-de-banco-de-dados/shareplex">
                                <img class="pull-left pd-all-10 pd-lf-0" src="<?php echo $this->_tpl_vars['URL']; ?>
...
software/dell/backup-e-replicacao-de-banco-de-dados/shareplex"> Shareplex </a></h3>
                        </div>   
                        <div class="col-xs-12 col-sm-8 col-md-8 pd-left-none">     
                            <h4 class="sub-titulo-interna-inst mg-top-none"><strong><a class="sub-azul" href="<?php echo $this->_tpl_vars['URL']; ?>
software/dell/backup-e-replicacao-de-banco-de-dados/shareplex"> Integração de dados em tempo real e replicação de banco de dados da Oracle </a></strong></h4>
                            <p class="txt-interna"><a href="<?php echo $this->_tpl_vars['URL']; ?>
software/dell/backup-e-replicacao-de-banco-de-dados/shareplex"> Obtenha alto desempenho, replicação de dados e integração de dados quase em tempo real por um custo mais baixo com o SharePlex, uma alternativa repleta de recursos para o Oracle GoldenGate®. Aproveite os recursos de replicação para o Oracle 10g, 11g, 12c, Oracle para SQL Server, Oracle para Hadoop, Oracle ao SAP ASE e outros bancos de dados. Obtenha a disponibilidade, a escalabilidade e a integração de dados com a replicação de alta velocidade de Oracle® para Oracle e de Oracle para outros bancos de dados. </a></p>
                        </div> 
                    </div>
                    <div class="row pd-tp-30">
                        <div class="col-xs-12 col-sm-3 col-md-3">
                            <a href="<?php echo $this->_tpl_vars['URL']; ?>
software/dell/backup-e-replicacao-de-banco-de-dados/shareplex-connector-for-hadoop">
                                <img class="pull-left pd-all-10 pd-lf-0" src="<?php echo $this->_tpl_vars['URL']; ?>
...
software/dell/backup-e-replicacao-de-banco-de-dados/shareplex-connector-for-hadoop"> Shareplex Connector for Hadoop </a></h3>
                        </div>   
                        <div class="col-xs-12 col-sm-8 col-md-8 pd-left-none">     
                            <h4 class="sub-titulo-interna-inst mg-top-none"><strong><a class="sub-azul" href="<?php echo $this->_tpl_vars['URL']; ?>
software/dell/backup-e-replicacao-de-banco-de-dados/shareplex-connector-for-hadoop"> Obtenha um conector de dados do Oracle para o Hadoop fácil de usar  </a></strong></h4>
                            <p class="txt-interna"><a href="<?php echo $this->_tpl_vars['URL']; ?>
software/dell/backup-e-replicacao-de-banco-de-dados/shareplex-connector-for-hadoop"> Com o SharePlex Connector for Hadoop carregue e replique continuamente as alterações de um banco de dados Oracle® para um cluster Hadoop® com o SharePlex™ Connector for Hadoop®. </a></p>
                        </div> 
                    </div>   
                    <br><br>                
                </article>
