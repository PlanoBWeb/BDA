...
commom/img/bg-software2.jpg" alt="Toad Intelligence Central " title="Toad Intelligence Central ">
                <div class="width-default">
                    <h1 class="titulo-faixa-interna"> Toad Intelligence Central </h1>
                </div>
                <img class="pull-right abs-right hidden-xs" src="<?php echo $this->_tpl_vars['URL']; ?>
commom/img/topo-interna-software.jpg" alt="Toad Intelligence Central " title="Toad Intelligence Central ">
            </article> 
            <!-- Banner -->
            <?php $_smarty_tpl_vars = $this->_tpl_vars;
                            ...
                            <div class="encapsula-desc-prod pd-tp-30">
                                <div class="bloco-desc-prod">
                                    ...
                                    <p class="txt-interna">
                                        ...
                                        Disponível para usuários do Toad Data Point e do Toad for Oracle:<br><br>
                                        <strong>Publicação de artefatos</strong> — Compartilhe todos os artefatos do Toad com seus outros usuários, incluindo diagramas, consultas visuais, automação, arquivos SQL e muito mais.
                                        <strong>Gerenciamento de direitos e controle de dados</strong> — Gerencie permissões e direitos de acesso para recursos compartilhados, preserve as regras de controle de dados.
                                    ...
                                    <ul class="bloco-linha-interna no-bg">
                                        ...
                                        <li class="linha-ul-interna">Repositório de dados — Armazene conjuntos de dados ou snapshots e agende atualizações regulares.</li>
                                        <li class="linha-ul-interna">Integração da visualização de dados — Conecte-se e compartilhe dados com usuários de ferramentas de visualização de terceiros, como Microsoft®, Tableau®, Qlik® Sense™ e Spotfire®.</li>
