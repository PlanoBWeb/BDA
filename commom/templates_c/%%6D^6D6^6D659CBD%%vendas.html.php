<?php /* Smarty version 2.6.12, created on 2016-03-30 16:24:02
         compiled from vendas.html */ ?>
<!DOCTYPE HTML>
<html lang="pt-br">
<head>
	<meta charset="utf-8">
...
commom/img/bg-solucoes1.jpg" alt="VENDAS" title="VENDAS"> 
                <div class="width-default">
                    <h1 class="titulo-faixa-interna">VENDAS</h1>
                </div>
                <img class="pull-right abs-right hidden-xs" src="<?php echo $this->_tpl_vars['URL']; ?>
commom/img/bg-solucoes2.jpg" alt="VENDAS" title="VENDAS">
            </article> 
            <!-- Banner -->
            <?php $_smarty_tpl_vars = $this->_tpl_vars;
...
commom/img/icon-vendas.png" alt="Vendas" title="Vendas">
                                    ...
                                    <div class="row">
                                        <h2 class="txt-destaques-home align-center mg-top--5">Vendas</h2>
                                    </div>
                                </div>
                                <?php $_smarty_tpl_vars = $this->_tpl_vars;
...
unset($_smarty_tpl_vars);
 ?> 
                            ...
                            <div class="col-xs-12 col-sm-8 col-md-8 pd-none pd-so-mob">
                                <p class="txt-interna">
                                    Com uma plataforma de análise universal ajudamos as empresas a identificar rapidamente novas oportunidades, detectar tendências emergentes, e tomar decisões mais inteligentes com painéis interativos, aplicativos analíticos vendas e visualizações de dados.<br><br>

                                    Organizações de vendas que usam ferramentas de automação como a Salesforce, se tornam mais eficazes, acesso transparente e melhoram os dados de vendas, aumentando a visibilidade do produto agilizando assim o desempenho de toda a força de vendas. Com estes dados a BDA otimiza o seu negócio e gera valor agregado por exemplo na Gestão do Pipeline.
                                </p><br><br>
                            </div>
                        </div>
                    </div>
